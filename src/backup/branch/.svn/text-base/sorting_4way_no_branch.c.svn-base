...
static int merge_4way(float ** bufs, int BLOCK_SIZE)
{
				...
				for(step = 0, chunk_size=VLEN; chunk_size * 4 <= BLOCK_SIZE; step++, chunk_size *= 2)
				{
									 ...
									 )
								{
										...
										//		get_from_front1 |= !(idx2 < chunk2end);
										//		get_from_front1 &= (idx1 < chunk1end);
												get_from_front3 = (last3 < last4);
										//		get_from_front3 |= !(idx4 < chunk4end);
										//		get_from_front3 &= (idx3 < chunk3end);
												get_from_front5 = (last5 < last6);
										//		get_from_front5 |= !(idx6 < chunk6end);
										//		get_from_front5 &= (idx5 < chunk5end);
												get_from_front7 = (last7 < last8);
										//		get_from_front7 |= !(idx8 < chunk8end);
										//		get_from_front7 &= (idx7 < chunk7end);
