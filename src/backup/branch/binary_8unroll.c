...
#define MANUAL_UNROLL
				...
				unsigned int idx5, idx6, idx7, idx8;
				unsigned int curidx1, curidx2, curidx3, curidx4;
				unsigned int curidx5, curidx6, curidx7, curidx8;
				...
				for(i = 0; i + 7 < count; i+=8)
				{
						...
						_VECTOR item5 = _MM_SET1(x5);
						_VECTOR item6 = _MM_SET1(x6);
						_VECTOR item7 = _MM_SET1(x7);
						_VECTOR item8 = _MM_SET1(x8);
						tst = VLEN;
#ifdef __MIC__
						...
						curidx5 = _mm512_cmp_ps_mask(item5, xmm_range , _CMP_GE_OS);
						idx5 = curidx5 = table[curidx5];
						curidx6 = _mm512_cmp_ps_mask(item6, xmm_range , _CMP_GE_OS);
						idx6 = curidx6 = table[curidx6];
						curidx7 = _mm512_cmp_ps_mask(item7, xmm_range , _CMP_GE_OS);
						idx7 = curidx7 = table[curidx7];
						curidx8 = _mm512_cmp_ps_mask(item8, xmm_range , _CMP_GE_OS);
						idx8 = curidx8 = table[curidx8];
						...
						curidx5 = _mm_movemask_ps( _mm_cmpge_ps(item5, xmm_range ));
						curidx6 = _mm_movemask_ps( _mm_cmpge_ps(item6, xmm_range ));
						curidx7 = _mm_movemask_ps( _mm_cmpge_ps(item7, xmm_range ));
						curidx8 = _mm_movemask_ps( _mm_cmpge_ps(item8, xmm_range ));
#elif AVX
						...
						curidx5 = _mm256_movemask_ps( _mm256_cmp_ps(item5, xmm_range , _CMP_GE_OS));
						curidx6 = _mm256_movemask_ps( _mm256_cmp_ps(item6, xmm_range , _CMP_GE_OS));
						curidx7 = _mm256_movemask_ps( _mm256_cmp_ps(item7, xmm_range , _CMP_GE_OS));
						curidx8 = _mm256_movemask_ps( _mm256_cmp_ps(item8, xmm_range , _CMP_GE_OS));
#endif
						idx1 = curidx1 = table[curidx1];
						idx2 = curidx2 = table[curidx2];
						idx3 = curidx3 = table[curidx3];
						...
						for(j = 1; j < HEIGHT / H_OFFSET; j++)
						{
								...
								_VECTOR xmm_range5 = _MM_LOAD(simd_pack + tst + idx5 * VLEN);
								_VECTOR xmm_range6 = _MM_LOAD(simd_pack + tst + idx6 * VLEN);
								_VECTOR xmm_range7 = _MM_LOAD(simd_pack + tst + idx7 * VLEN);
								_VECTOR xmm_range8 = _MM_LOAD(simd_pack + tst + idx8 * VLEN);
								tst = VLEN * tst + VLEN;
								...
								curidx5 = _mm512_cmp_ps_mask(item5, xmm_range5, _CMP_GE_OS);
								idx4 = VLEN * idx4 + curidx4;
								curidx5 = table[curidx5];
								curidx6 = _mm512_cmp_ps_mask(item6, xmm_range6, _CMP_GE_OS);
								idx5 = VLEN * idx5 + curidx5;
								curidx6 = table[curidx6];
								curidx7 = _mm512_cmp_ps_mask(item7, xmm_range7, _CMP_GE_OS);
								idx6 = VLEN * idx6 + curidx6;
								curidx7 = table[curidx7];
								curidx8 = _mm512_cmp_ps_mask(item8, xmm_range8, _CMP_GE_OS);
								idx7 = VLEN * idx7 + curidx7;
								curidx8 = table[curidx8];
								idx8 = VLEN * idx8 + curidx8;
								...
								curidx5 = _mm_movemask_ps( _mm_cmpge_ps(item5, xmm_range5));
								curidx6 = _mm_movemask_ps( _mm_cmpge_ps(item6, xmm_range6));
								curidx7 = _mm_movemask_ps( _mm_cmpge_ps(item7, xmm_range7));
								curidx8 = _mm_movemask_ps( _mm_cmpge_ps(item8, xmm_range8));
#elif AVX
								...
								curidx5 = _mm256_movemask_ps( _mm256_cmp_ps(item5, xmm_range5, _CMP_GE_OS));
								curidx6 = _mm256_movemask_ps( _mm256_cmp_ps(item6, xmm_range6, _CMP_GE_OS));
								curidx7 = _mm256_movemask_ps( _mm256_cmp_ps(item7, xmm_range7, _CMP_GE_OS));
								curidx8 = _mm256_movemask_ps( _mm256_cmp_ps(item8, xmm_range8, _CMP_GE_OS));
#endif
								curidx1 = table[curidx1];
								curidx2 = table[curidx2];
								curidx3 = table[curidx3];
